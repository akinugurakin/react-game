            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  "bg-white shadow-xl border border-brand-sand/30",
                )}
                style={{
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4">
                    <span className="text-2xl select-none cursor-pointer text-brand-sand/50 hover:text-brand-teal">
                      &larr;
                    </span>
                    <span className="text-2xl select-none cursor-pointer text-brand-sand/50 hover:text-brand-teal">
                      &rarr;
                ...
                <div className="p-6 flex flex-col items-center gap-4 pt-10">
                  <img
                    ...
                    className="w-16 h-16 rounded-full object-cover ring-2 ring-brand-lime/30"
                  />
